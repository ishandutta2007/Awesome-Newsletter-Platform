...
<p align="center">
  <img src="assets/banner.svg" alt="Awesome Newsletter Platform Banner" width="100%" />
</p>
...
```mermaid
flowchart TD
    A[✍️ Content Creation & Drafting] --> B[📋 Editorial Review & HTML Build]
    B --> C[🎯 Dynamic Audience Segmentation]
    C --> D[⏰ Campaign Scheduling]
    D --> E[🚀 Email Delivery Engine / SMTP]
    E --> F[📥 Subscriber Inbox Delivery]
    F --> G[📈 Open, Click, Reply & Conversion Events]
    G --> H[📊 Real-Time Campaign Analytics]
    H --> I[👥 Subscriber Segmentation & Journey Updates]
```

```mermaid
flowchart LR
    subgraph Capture["1. Acquisition"]
        A[🌐 Landing Page] --> B[📝 Signup Form]
    end

    subgraph Core["2. Platform Core"]
        B --> C[📬 Listmonk / Ghost / Keila]
        D[🔄 n8n Automation] --> C
    end

    subgraph Infrastructure["3. Delivery Layer"]
        C --> E[🚀 Postal / SMTP Server]
        E --> F[👥 Reader Inbox]
    end

    subgraph AnalyticsLayer["4. Telemetry"]
        F --> G[📊 Plausible / Matomo / Metabase]
        G --> D
    end
```
...
[![Star History Chart](https://star-history.dera.page/svg?repos=ishandutta2007/Awesome-Newsletter-Platform&type=date&legend=top-left)](https://star-history.dera.page/#ishandutta2007/Awesome-Newsletter-Platform&type=date&legend=top-left)
...
<p align="center">
  <b>Made for newsletter creators, publishers, media companies, marketers, communities, developers and organizations building open email publishing infrastructure.</b><br>
