...
flowchart TD
    ...
    A[Content Creation] --> B[Newsletter Draft]
    ...
    D --> E[Campaign Scheduling]

    E --> F[Email Delivery]



    F --> G[Subscriber Inbox]



    G --> H[Open and Click Events]

    H --> I[Campaign Analytics]



    I --> J[Audience Insights]

    J --> K[Future Content and Segmentation]
...
flowchart LR
    ...
    A[Publishing Platform] --> B[Ghost / WordPress]



    C[Subscriber Forms] --> D[Newsletter Platform]
    ...
    D[Listmonk / Keila / Mailtrain] --> E[Email Delivery Layer]
...
flowchart LR
    ...
    A[Subscriber Acquisition] --> B[Signup]

    B --> C[Verification and Preferences]
    ...
    E --> F[Campaign Creation]



    F --> G[Send or Schedule]

    G --> H[Email Delivery]



    H --> I[Open / Click / Reply]

    I --> J[Analytics]



    J --> K[Audience Optimization]
